...
#Estonia
EE14 <- gtrends(c("euroopa Liit", "euroopa parlamendi valimised", "evropský parlament"), geo = "EE", time = "2014-04-25 2014-05-25", low_search_volume =T)
EE19 <- gtrends(c("euroopa Liit", "euroopa parlamendi valimised", "evropský parlament"), geo = "EE", time = "2019-04-26 2019-05-26", low_search_volume =T)
